...
# If you need user_sessions in callbacks too, import it:
...
async def settings_callback(client: Client, callback_query: CallbackQuery):
    ...
    if data.startswith("mode_"):
        ...
        # Optional: update active session if exists
        # try:
        #     from Plugins.sequence import user_sessions
    ...
    # ─── Other existing callbacks (about, help, start, etc.) ───────
    elif data == "about":
    ...
    # ─── ForceSub related callbacks (unchanged) ───────────────────
